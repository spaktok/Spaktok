...
void main() {
  ...
  late ChatBackgroundService chatBgService;

  setUp(() {
    themeService = ThemeService();
    chatBgService = ChatBackgroundService();
  });

  group('Spaktok App Tests', () {
    testWidgets('App should start with MainNavigationScreen',
        (WidgetTester tester) async {
      await tester.pumpWidget(
          MyApp(themeService: themeService, chatBgService: chatBgService));
    ...
    testWidgets('FloatingActionButton should be visible on Explore screen',
        (WidgetTester tester) async {
      await tester.pumpWidget(
          MyApp(themeService: themeService, chatBgService: chatBgService));
  ...
  group('Screen Tests', () {
    testWidgets('ExploreScreen should display correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('CameraScreen should display correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('StoryScreen should display correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('ReelScreen should display correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('LiveStreamScreen should display correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: LiveStreamScreen(
              channelName: 'test-channel', isBroadcaster: false),
        ),
      );
  ...
  group('Theme Tests', () {
    testWidgets('App should use dark theme by default',
        (WidgetTester tester) async {
      await tester.pumpWidget(
          MyApp(themeService: themeService, chatBgService: chatBgService));
  ...
  group('Localization Tests', () {
    testWidgets('App should support multiple locales',
        (WidgetTester tester) async {
      await tester.pumpWidget(
          MyApp(themeService: themeService, chatBgService: chatBgService));
    ...
    testWidgets('App should have localization delegates',
        (WidgetTester tester) async {
      await tester.pumpWidget(
          MyApp(themeService: themeService, chatBgService: chatBgService));
