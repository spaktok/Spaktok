...
/// The translations for Church Slavic Church Slavonic Old Bulgarian Old Church Slavonic Old Slavonic (`cu`).
class AppLocalizationsCu extends AppLocalizations {
  AppLocalizationsCu([String locale = 'cu']) : super(locale);
