...
class _EnhancedLiveStreamScreenState extends State<EnhancedLiveStreamScreen> {
  ...
  Future<void> _handleIncomingGift(Map<String, dynamic> data) async {
    ...
    if (giftName.toLowerCase().contains('nuke') || giftName.toLowerCase().contains('nuclear') || 
        giftName.contains('explosion') || giftName.contains('انفجار')) {
  ...
  String? _soundForGift(String giftName) {
    ...
    if (name.contains('mansion') || name.contains('house') || name.contains('قصر') || name.contains('منزل')) return 'sounds/mansion.mp3';
    ...
    if (name.contains('money') || name.contains('cash') || name.contains('مال') || name.contains('أموال')) return 'sounds/money.mp3';
    if (name.contains('party') || name.contains('celebration') || name.contains('احتفال')) return 'sounds/party.mp3';
    if (name.contains('nuke') || name.contains('nuclear') || name.contains('explosion') || name.contains('انفجار')) return 'sounds/nuke.mp3';
    return null;
  }
  ...
  String? _lottieForGift(String giftName) {
    ...
    if (name.contains('mansion') || name.contains('house') || name.contains('قصر') || name.contains('منزل')) return 'assets/animations/mansion.json';
    ...
    if (name.contains('money') || name.contains('cash') || name.contains('مال') || name.contains('أموال')) return 'assets/animations/money.json';
    if (name.contains('party') || name.contains('celebration') || name.contains('احتفال')) return 'assets/animations/party.json';
    return null;
  }
