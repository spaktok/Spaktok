...
class AdvancedVideoEffectsService {
  ...
  Future<String> applyGreenScreen({
    ...
    try {
      ...
      print('Error applying green screen: $e');
      rethrow;
    }
  }
  ...
  Future<void> applyVoiceEffect({
    ...
    try {
      ...
      print('Error applying voice effect: $e');
      rethrow;
    }
  }
  ...
  Future<void> applyTimeEffect({
    ...
    try {
      ...
      print('Error applying time effect: $e');
      rethrow;
    }
  }
  ...
  Future<List<Map<String, dynamic>>> generateAutoCaptions({
    ...
    try {
      ...
      print('Error generating auto-captions: $e');
      rethrow;
    }
  }
  ...
  Future<void> addStickerOverlay({
    ...
    try {
      ...
      print('Error adding sticker overlay: $e');
      rethrow;
    }
  }
